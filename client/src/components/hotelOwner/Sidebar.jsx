...
const Sidebar = () => {
    ...
    const sidebarLinks = [
        ...
        { name: "List", path: "/owner/list-room", icon: assets.listIcon },

    ]

    return (
        <div className="md:w-64 w-16 border-r h-full text-base border-gray-300 pt-4 flex flex-col transition-all durartion-300">
