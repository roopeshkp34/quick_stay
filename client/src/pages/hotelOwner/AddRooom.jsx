...
const AddRoom = () => {
    ...
    return (
        <form>
            <Title align="left" font="outfit" title="Add Room" subTitle="Fill in the details carefully and acurate room details, pricing, and ammenities, to enhance the user booking expirience." />
            ...
            <div className="w-full flex max-sm:flex-col sm:gap-4 mt-4">
                ...
                <div>
                    ...
                    <input type="number" placeholder="0" className="border border-gray-300 mt-1 rounded p-2 w-24" value={input.pricPerNight} onChange={e=>setInput({...input, pricPerNight : e.target.value})} />
                </div>
            </div>
